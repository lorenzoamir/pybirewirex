...
[![PyPI](https://img.shields.io/pypi/v/pybirewire)](https://pypi.org/project/pybirewire/)
[![Python](https://img.shields.io/pypi/pyversions/pybirewire)](https://pypi.org/project/pybirewire/)
[![Tests](https://github.com/lorenzoamir/PyBiRewire/actions/workflows/ci.yml/badge.svg)](https://github.com/lorenzoamir/PyBiRewire/actions/workflows/ci.yml)
[![Docs](https://readthedocs.org/projects/pybirewire/badge/?version=latest)](https://pybirewire.readthedocs.io/en/latest/)
...
Given a binary network (bipartite or undirected), PyBiRewire generates rewired
...
```bash
pip install pybirewire
```

With optional graph-object support (igraph / networkx):

```bash
pip install "pybirewire[graph]"
```
...
### Analysis — `birewire.analysis.bipartite` / `.undirected`
...
The dashed line marks the analytical bound N.

![Analysis figure](.github/images/demo_analysis.png)

### Monitoring — `birewire.visual.monitoring.bipartite` / `.undirected`
...
![Monitoring figure](.github/images/demo_monitoring.png)
...
Full API docs at **[pybirewire.readthedocs.io](https://pybirewire.readthedocs.io)**. WORK IN PROGRES!!!
...
If you use PyBiRewire in published research, please cite the original BiRewire
paper:
